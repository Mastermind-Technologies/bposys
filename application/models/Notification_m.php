...
class Notification_m extends CI_Model {
  ...
  public function get_applicant_notif($roleId = null, $userId = null)
  {
    ...
    $this->db->select('notifications.referenceNum, notifications.notifMessage,notifications.createdAt')->from($this->table)->join($this->reference, 'reference_numbers.referenceNum = notifications.referenceNum')->limit(10)->order_by("notifications.createdAt", "desc");
    $result = $this->db->get();

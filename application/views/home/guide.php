<body>
  <div class="container">
    <div class="row" style="margin-top: 50px">
  	...
  	<div class="row" style="margin-top: 50px">
  		<div class="timeline-centered" style="width: 80%; left: 10%; right: 10%">

  	<article class="timeline-entry">

  		<div class="timeline-entry-inner">
  			<!-- <time class="timeline-time"><span>Step 1</span> <span>BPOSys Site</span></time> -->
  			...
  			<div class="timeline-label">
  				...
  				<p>Start by signing up for an account and fill all necessary details. If you already have an account, fill up and submit a copy of unified form for your business permit application. Set up a schedule for appointment with BPLO, and then either print, copy, or take a photo of the reference number.</p>
          <br />
  	...
  	<article class="timeline-entry">
  		...
  		<div class="timeline-entry-inner">
  			<!-- <time class="timeline-time"><span>Step 2</span> <span>BPLO</span></time> -->

  			<div class="timeline-icon bg-secondary">
  				<i class="entypo-suitcase">2</i>
  			</div>

  			<div class="timeline-label">
  				<h2>Interview and Assessment of Fees</h2>
  				<p>Proceed to BPLO on your appointment date. Bring all of the requirements stated below. You have to pass the interview with the BPLO head regarding your application for a business permit. Afterwards, your application will be assessed for its corresponding fees. An assessment of fees will be printed out for you, and you have to pay for it in the treasury of the city hall and return with the Official Receipt (OR). </p>

          <p><b>What to bring in your appointment:</b></p>
          <ul>
            <li>ID with the ID number you stated</li>
            <li>Printed, written, or clear picture of your reference number</li>
            <li>DTI/SEC/CDA Registration</li>
            <li>Barangay Clearance</li>
            <li>Authorization letter from owner (If you are not the owner of the business)</li>
          </ul>
  			</div>
  		</div>
  	...
  	<article class="timeline-entry" style="width: 100%;">  <!-- left-aligned -->
  	...
  	<!-- <article class="timeline-entry begin">
  		...
  		<div class="timeline-entry-inner">
  			...
  			<div class="timeline-icon" style="-webkit-transform: rotate(-90deg); -moz-transform: rotate(-90deg);">
  				<i class="entypo-flight">5</i>
  			</div>

        <div class="timeline-label" style="width: 100%">
          fas
        </div>
  		</div>

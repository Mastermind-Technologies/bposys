<div id="content">
  ...
  <div id="content-header">
    ...
    <h1>BPLO Application Reports <button class="btn btn-success"><i class="icon-print"></i> Print Numerical</button> <button class="btn btn-primary"><i class="icon-print"></i> Print Graphical</button></h1>
    <hr style="margin:10">
  </div>
  <!--End-breadcrumbs-->
